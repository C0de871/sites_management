...
class FormHubScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<PostVisitedSiteCubit, PostVisitedSiteState>(
        builder: (context, state) {
          final cubit = context.read<PostVisitedSiteCubit>();
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isValid ? Theme.of(context).colorScheme.secondary.withOpacity(0.9) : Theme.of(context).colorScheme.surface.withOpacity(0.8),
                    shape: BoxShape.circle,
                    boxShadow: [
                      BoxShadow(
                        color: isValid ? Theme.of(context).colorScheme.secondary.withOpacity(0.3) : Colors.grey.withOpacity(0.2),
                        blurRadius: 8,
                        spreadRadius: 2,
                      ),
                    ],
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 12,
                    color: isValid ? Theme.of(context).colorScheme.onPrimary.withOpacity(0.7) : Theme.of(context).colorScheme.onSurface.withOpacity(0.7),
                  ),
                ),
              ],
            ),
