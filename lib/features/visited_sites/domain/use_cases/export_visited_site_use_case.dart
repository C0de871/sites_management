...
class ExportVisitedSiteUseCase {
  ...
  Future<Either<Failure, MessageModel>> call({required Map<String, dynamic> body, required String fileName}) {
    return repository.exportSites(body: body, fileName: fileName);
  }
}
